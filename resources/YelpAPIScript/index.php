 ...
 * Utilizes Yelp api to fetch computer repair service providers from Yelp directory for
 * the ten largest cities in the U.S., and insert them into the service providers table
 * in a MySQL database
 */
